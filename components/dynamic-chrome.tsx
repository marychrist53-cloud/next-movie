...
import { getFavoriteIds, getSetting, getUnreadCount, getUserRole, getWatchlistIds, getWatchedIds } from "@/lib/db";
...
export default async function DynamicChrome() {
	...
	const watchedIds = user ? await getWatchedIds(user.id) : [];
